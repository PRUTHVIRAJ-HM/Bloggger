  ...
  return(
    <div className='py-5 px-5 md:px-12 lg:px-28'>
      ...
      <div className='text-center my-8 bg-stone-200 py-8 px-2 rounded-xl'>
        ...
        <form action="" className='flex justify-between max-w-[500px] scale-75 sm:scale-100 mx-auto mt-10 border bg-white rounded-sm border-black shadow-[-7px_7px_0px_#000000]'>
